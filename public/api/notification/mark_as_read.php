...
// Récupérer les données POST ou du corps de la requête JSON
$postData = $_POST;
if (empty($postData)) {
...
try {
    ...
    error_log('Erreur dans mark_as_read.php: ' . $e->getMessage());
    
    // Renvoyer une réponse d'erreur
    echo json_encode([
        'success' => false,
        'message' => 'Une erreur s\'est produite lors du marquage de la notification comme lue.'
    ]);
}
