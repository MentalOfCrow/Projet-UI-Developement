...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-indigo-600 mb-8">Aide et règles du jeu</h1>
    
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        <h2 class="text-2xl font-bold text-indigo-600 mb-4">Règles du jeu de dames</h2>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        <h2 class="text-2xl font-bold text-indigo-600 mb-4">Comment jouer sur notre plateforme</h2>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <h2 class="text-2xl font-bold text-indigo-600 mb-4">Besoin d'aide supplémentaire ?</h2>
